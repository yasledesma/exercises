...
def getWordScore(word, n):
    ...
    returns: int >= 0
    """
    letters_freq = getFrequencyDict(word)
    partial_score = 0

    for letter in letters_freq:
        partial_score += (SCRABBLE_LETTER_VALUES[letter] * letters_freq[letter])

    final_score = partial_score * len(word)
